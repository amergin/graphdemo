        ...
        .attr("id", function(d) { return d.id; } )
            ...
            .on("mouseover", function(d) {
              ...
              timer = setTimeout( function() {
                ...
                selection.transition().duration(150).style("stroke-width", initialWidth + Number(4) )
            ...
            .on("mouseout", function(d) {
              ...
              var selection = d3.select(this);
              timer = setTimeout( function() {
                selection.transition().duration(150).style("stroke-width", getLinkStroke( selection.data()[0] ) )
