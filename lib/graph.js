...
window.App.Graph.initGraph = function() //json, patientBarcodes )
{
  var conf = App.Graph.config;
      ...
      var maxScore = App.Models.nodes.max( function(ele) { return ele.get('gene_interesting_score'); } ).get('gene_interesting_score') || 0;
      var minScore = App.Models.nodes.min( function(ele) { return ele.get('gene_interesting_score'); } ).get('gene_interesting_score') || 0;
