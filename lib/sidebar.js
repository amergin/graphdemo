...
window.App.Sidebar.Plot.categorical = function( sourcePatientValues, targetPatientValues, sourceLabel, targetLabel )
    {
...
window.App.Sidebar.BoxPlotConfig = {
        exporting: {
          enabled: false
        },
        chart: {
...
window.App.Sidebar.BoxPlotInfo = function( categoricalValues )
    {
      var chart;
      var series = {};
      var category;
      var classification;
      var percentage;
      var chartConfig = App.Sidebar.BoxPlotConfig;
...
window.App.Sidebar.BoxPlot = function(numericValues, categoricalValues)
    {
        var conf = App.Sidebar.BoxPlotConfig;
        $(conf.container).prev('h3').find('a').fadeOut( function() { $(this).text('Box Plot').fadeIn(); } );
...
window.App.Sidebar.Info.infovalues = function( sourceNodeo, targetNodeo, edgeo )
    {
...
window.App.Sidebar.Plot.scatterplot = function( sourceNodeo, targetNodeo ) //, patientBarcodes )
    {
