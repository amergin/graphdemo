...
window.App.Sidebar.Plot.boxPlotInfo = function(params)
    {
      var chartConfig = App.Sidebar.Plot.BoxPlotConfig;
      var categoricalValues = params.categoricalO;
      var patientSampleClassifications = App.Models.get('active').get('samples');
...
window.App.Sidebar.Plot.scatterplot = function(params)// sourceNodeo, targetNodeo )
    {
        ...
        var sourcePlot = params.sourceO.patientvals;//.split(":");
        var targetPlot = params.targetO.patientvals;//.split(":");
