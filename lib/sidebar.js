...
window.App.Sidebar.Plot.scatterplot = function(params)// sourceNodeo, targetNodeo )
{
  ...
  scatterplotConfig.xAxis.title['text'] = App.Utilities.createNodeLabel2( sourceO ); //params.sourceO.source + " of " + params.sourceO.label + ", chr " + params.sourceO.chr;
  scatterplotConfig.yAxis.title['text'] = App.Utilities.createNodeLabel2( targetO ); //params.targetO.source + " of " + params.targetO.label + ", chr " + params.targetO.chr;
