...
// see https://gist.github.com/3902173 & 
...
window.App.Utilities.updateElements = function( json ) 
{
  ...
  // these fires are bound to several views
  // the order of reset is important
  App.Models.nodes.reset( nodes );
  App.Models.edges.reset( edges );
...
window.App.Utilities.eventAggregator = _.extend({}, Backbone.Events);
