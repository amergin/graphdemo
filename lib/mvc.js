...
jQuery( function($) 
{
	...
	window.ClinicalSearchView = Backbone.View.extend({
		...
		{	
          var query = { 
            ...
            clinicalNodeId: $('#clinSelect select[name="node"] option:selected').val(),
            middleNodeType: $("#clinSelect #middleNodeType option:selected").attr("id"),
            targetType: $('#clinSelect select#sourceNodeType option:selected').attr('id'),
            mutatedType: $('#clinSelect select#sourceNodeType option:selected').attr('type'),
	...
	window.GraphView = Backbone.View.extend({
		...
		initialize: function(model) {
			...
			// def. backbone view doesn't have defaults, won't override backbone's own implementations
