...
jQuery( function($) 
{
	...
	window.ClinicalSearchView = Backbone.View.extend({
		...
		{	
          ...
          {
          	case: 'METH': query['gexpTargetCorrelationType'] = 'negative'; break;
          	case: 'CNVR': query['gexpTargetCorrelationType'] = 'positive'; break;
          	case: 'MIRN': query['gexpTargetCorrelationType'] = 'negative'; break;
          	case: 'METH': query['gexpTargetCorrelationType'] = 'negative'; break;
          };
...
window.App.Utilities.updateElements = function( json ) 
{
	...
	if( json.nodes.length === 0 || json.links.length === 0 ) return;
    ...
    // these will fire add event, listened by searches
