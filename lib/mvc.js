	...
	window.AppView = Backbone.View.extend({
		...
		initialize: function()
		{
	      ...
	      $('#filter').tabs( { selected: '#clinSearch' });	      
			...
			this.header = window.App.Views.header = new HeaderView(
				{ App.Views.graph.el.id: App.Views.graph, 
					App.Views.heatmap.el.id: App.Views.heatmap, 
					App.Views.paths.el.id: App.Views.paths 
				});
