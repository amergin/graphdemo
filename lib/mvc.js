	...
	window.AppView = Backbone.View.extend({
		...
		initialize: function()
		{
	      ...
	      $('#filter').tabs( { selected: '#clinSearch' });	      
			...
			// header tab views
			this.graph = window.App.Views.graph = new HeaderTabView({ model: this.datasets, el: $('#graphTab.headertab'), tabId: 0, tabFunction: App.Graph.initGraph });
			this.heatmap = window.App.Views.heatmap = new HeaderTabView({ model: this.datasets, el: $('#heatmapTab.headertab'), tabId: 1, tabFunction: App.Heatmap.initHeatmap });
			this.paths = window.App.Views.paths = new HeaderTabView({ model: this.datasets, el: $('#pathTab.headertab'), tabId: 2, tabFunction: App.Graph.initPaths });
