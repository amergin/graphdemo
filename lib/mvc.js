	...
	window.AppView = Backbone.View.extend({
		...
		initialize: function()
		{
	      ...
	      $('#filter').tabs( { selected: '#clinSearch' });	      
			...
			this.graph.tabFunction = App.Heatmap.initHeatmap;

			this.paths = window.App.Views.paths = new HeaderTabView( { model: this.datasets, el: $('#heatmapTab.headertab'), tabId: 2 } );
			this.graph.tabFunction = App.Paths.initPaths;
