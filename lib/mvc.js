...
jQuery( function($) 
{
	...
	window.Dataset = Backbone.Model.extend( {
		...
		initialize: function(options)
		{
	        ...
	        $.ajax( {
	                type: options.fetchClinType,
	                url: options.fetchClinURL,
	                dataType: "json",
	                //async: false,
	                ...
	                {
	                	self.set({ clinicalNodes: json.nodes });
	                },
	        ...
	        $.ajax( {
	                type: options.fetchSampleType,
	                url: options.fetchSampleURL,
	                dataType: "json",
	                //async: false,
	                data: JSON.stringify( { datalabel: self.name } ),
	                contentType: "application/json",
